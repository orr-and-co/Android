...
import kotlinx.android.synthetic.main.fragment_filtered_feed.*
import retrofit2.Call
import retrofit2.Callback
import retrofit2.Response

class FilteredFeedFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val refreshLayout = view.findViewById<SwipeRefreshLayout>(R.id.refreshLayoutFiltered)
